...
type Cluster struct {
	...
	OrganizationID      uuid.UUID       `json:"organization_id" gorm:"type:uuid;not null;index:idx_clusters_organization_id"`
	...
	CredentialType      string          `json:"credential_type" gorm:"size:64;not null;default:'';index:idx_clusters_credential_type"`
	EncryptedCredential string          `json:"-" gorm:"type:text;not null;default:''"`
	KubeconfigEncrypted string          `json:"-" gorm:"type:text;not null;default:''"`
	KubernetesVersion   string          `json:"kubernetes_version" gorm:"size:64;not null;default:''"`
