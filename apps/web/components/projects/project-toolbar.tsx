...
type ProjectToolbarProps = { filters: ProjectFilters; view: ProjectView; onFiltersChange: (filters: Partial<ProjectFilters>) => void; onViewChange: (view: ProjectView) => void; onRefresh: () => void; onCreate: () => void; refreshing?: boolean };
