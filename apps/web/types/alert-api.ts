...
export type AlertQueryParams = { page?: number; limit?: number; search?: string; sort?: "created_at" | "updated_at" | "severity" | "status" | "last_seen_at"; order?: "asc" | "desc"; projectId?: string; severity?: string; status?: string; source?: string; incidentId?: number };
