...
export type MetricAggregationParams = { projectId: string; clusterId?: string; resourceId?: string; metricType: string; metricName?: string; interval?: "minute" | "hour" | "day"; start: string; end: string };
export type ClusterOrResourceMetricsParams = { projectId: string; metricType: string; metricName?: string; start?: string; end?: string; limit?: number };
export type ApplicationMetricsStatus = { available: boolean; reason?: string };
export type MetricsStatusResponse = { clusterId: string; kubernetesReachable: boolean; metricsServerAvailable: boolean; lastCollectedAt?: string; applicationMetrics: ApplicationMetricsStatus };
